...
@Component({
  ...
  template: `<div id="add-confirmation-dialog" class="hs-overlay hidden ti-modal no-print" style="z-index: 200;">
  <div
    class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center"
  >
    <div class="ti-modal-content">
      <div class="ti-modal-header">
        <h3 class="ti-modal-title">Add confirmation</h3>
        <button
          type="button"
          class="hs-dropdown-toggle ti-modal-close-btn"
          id="add-cancel-button-2"
