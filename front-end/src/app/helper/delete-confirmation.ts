...
export const showConfirmationDialog = (): Promise<boolean> => {
  ...
  overlay.setAttribute('class', 'transition duration fixed inset-0 z-50 bg-gray-900 bg-opacity-50 dark:bg-opacity-80 hs-overlay-backdrop');
